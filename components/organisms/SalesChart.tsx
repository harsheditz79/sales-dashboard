    ...
    return (
        <Card className="w-full">
            <div className="flex justify-between items-center mb-6">
                ...
                <FilterInput label="Threshold" value={threshold} onChange={setThreshold} />
            </div>
            <div className="flex gap-2 mb-4">
                <Button onClick={() => setChartType('bar')} isActive={chartType === 'bar'}>Bar</Button>
                <Button onClick={() => setChartType('line')} isActive={chartType === 'line'}>Line</Button>
                <Button onClick={() => setChartType('pie')} isActive={chartType === 'pie'}>Pie</Button>
            </div>
